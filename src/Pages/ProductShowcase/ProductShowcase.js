...
export default function ProductShowcase () {
    ...
    //useParams() permet de retrouver l'id qui a été indiqué dans la route vers ProductShowCase
    //console.log(id) : nom de ce qu'il y a après le /

    const productClicked = inventory.findIndex(obj => obj.title.replace(/\s+/g, '').trim() === id)

    //findIndex va sortir l'index du produit pour lequel la condition specifiée est vraie, c'est à dire que le titre correspond à l'id
